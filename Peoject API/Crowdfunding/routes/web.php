...
Route::get('/projectdetails',[ProjectController::class,'projectdetails'])->name('project.projectdetails');
Route::get('/donationhistory/{id}',[ProjectController::class,'donationhistory'])->name('project.donationhistory');
