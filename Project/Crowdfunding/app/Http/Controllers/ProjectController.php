...
class ProjectController extends Controller
{
    ...
    {
        $initiator=Initiator::where('i_email',session()->get('initiator.email'))->first();
      ...
      //  return $project;
        ...
        return view('initiator.pages.project.homepage')->with('project',$project);
    }
    ...
    public function proposeprojectSubmit(Request $request){
     ...
     public function projectdetails()
     {
       ...
       $project=Project::where('i_id',$initiator->i_id)->get();
                        

        //return $project;

         return view('initiator.pages.project.projectdetails')->with('project',$project);
     }
     ...
     public function donationhistory(Request $request)
     {
       ...
       return view('initiator.pages.project.donationhistory')->with('data',$data);
     }
     ...
     public function searchproject()
     {
       ...
       $project=Project::where('i_id',$initiator->i_id)
        ...
        return view('initiator.pages.project.searchproject')->with('project',$project);
     }
     ...
     public function filterprojectstatus(Request $request)
     {
      ...
      $project=Project::where('i_id',$initiator->i_id)
        ...
        return view('initiator.pages.project.filterprojectstatus')->with('project',$project);
     }
